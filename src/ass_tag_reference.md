...
| `\bord<size>`<br>`\xbord<size>`<br>`\ybord<size>`                                  | ✅            | מוסיף border בעובי X. וריאנטים מאפשרים לשלוט ולשחק בעובי לאורך הציר המתאים/שתבחר(אורך/רוחב/שניהם באיזון).                                             | [ראה עוד](#todo) |
| `\shad<size>`<br>`\xshad<size>`<br>`\yshad<size>`                                  | ✅            | מוסיף shadow בעובי X. וריאנטים מאפשרים לשלוט בעובי לאורך הציר המתאים/שתבחר(אורך/רוחב/שניהם באיזון).                                             | [ראה עוד](#todo) |
...
| `\fscx<X>`<br>`\fscy<Y>`<br>`\fscx<Z>`                                             | ✅            |  (scale) מתיחה של הכתובית בציר המתאים.                                                                             | [ראה עוד](#todo) |
| `\frx<X>`<br>`\fry<Y>`<br>`\frz<Z>`                                                | ✅            |  (rotation) סיבוב של הכתובית בציר המתאים/הנבחר(אופקי/אנכי).                                                                           | [ראה עוד](#todo) |
| `\fax<X>`<br>`\fay<X>`                                                             | ✅            | מבצע shearing (עיוות של פרספקטיבה) בציר המתאים.                                                                   | [ראה עוד](#todo) |
| `\c<X>`<br>`\$c<X>`                                                                | ✅            | קובע את הצבע של החלק המתאים/הנבחר(צבע ראשי/צבע מתחלף/מיתר/צללית) בכתובית. הצבעים בקידוד הייחודי של אגיסאב, ראו בחלק הייעודי.                           | [ראה עוד](#todo) |
...
| `\an<X>`                                                                           |              | (anchor) קובע את מיקום הרצוי של השורה, לפי 9 מיקומים שמוגדרים באגיסאב(משחק מיקום בין שמאל, ימין, מעלה,מטה, אמצע)    ראו פירוט ערך ייעודי                                          | [ראה עוד](#todo) |
...
| `\pos(<x>,<y>)`                                                                    |              | קובע את מיקום השורה לפי קואורדינטות(המספרים שניתן לראות מיקום דרכו במסך של האגיסאב). אי אפשר לשלב עם `\move`.                                                                     | [ראה עוד](#todo) |
| `\move(<x1>,<y1>,<x2>,<y2>)`<br><br>`\move(<x1>,<y1>,<x2>,<y2>,<t1>,<t2>)`         |              | מנפיש את מיקום השורה לאורך הניגון שלה לפי קואורדינטות. אי אפשר לשלב עם `\pos`.                                                    | [ראה עוד](#todo) |
...
| `\clip(<x1>,<y1>,<x2>,<y2>)`                                                       | ✅            | חותך את השורה לפי צורה שנבחרה, כך שרק מה שבמלבן המוגדר בתג זה יוצג.                                                                | [ראה עוד](#todo) |
| `\clip(drawing)`                                                                   |              | חותך את השורה לפי הצוררה שנוצרה על ידי(תוסף הציור), כך שרק מה שבתוך הצורה יוצג.                                                                         | [ראה עוד](#todo) |
| `\iclip(<x1>,<y1>,<x2>,<y2>)`                                                      | ✅            | חותך את השורה לפי צורה שנבחרה, כך שרק מה שמחוץ לצורה המוגדרת בתג זה יוצג.                                                                                                                | [ראה עוד](#todo) |
| `\iclip(drawing)`                                                                  |              | חותך את השורה לפי הצוררה שנוצרה על ידי(תוסף הציור), כך שרק מה שמחוץ לה, יוצג.                                                                         | [ראה עוד](#todo) |
| `\p<X>`                                                                            |              | מגדיר את מצב הציור. ראו ברשימת הערכים המיוחדים(חובה להשתמש על מנת שהצורה שנעשתה על ידי תוסף הציור תוצג).                                                                   | [ראה עוד](#todo) |
